...
3- Finde your server with directly run script "./fssh.sh <last_two_octets_or_hostname>" or use fssh command if you have added the path of script to .bashrc file by adding "export PATH=$PATH:path/to/script" to the .bashrc file <br />
